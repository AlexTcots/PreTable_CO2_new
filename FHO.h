...
//modify
    double Compute_pro_if_deex(int n, int i, int f,const std::vector<double>& Ebins, const double THETA_mole);
    double Compute_pro_if_exci(int n, int i, int f,const std::vector<double>& Ebins, const double THETA_mole);
